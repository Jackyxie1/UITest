...
public class CameraActivity extends BaseActivity implements OcrCallback, Handler.Callback, View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private byte[] testByte = new byte[]{0x47, 0x30, 0x30, 0x58, 0x30, 0x30, 0x59, 0x2D, 0x36, 0x30, 0x35, 0x5A, 0x2D, 0x30, 0x30, 0x0A};
    ...
    private byte[] testByteXN = new byte[]{0x47, 0x30, 0x30, 0x58, 0x2D, 0x38, 0x30, 0x59, 0x2D, 0x35, 0x35, 0x37, 0x5A, 0x2D, 0x30, 0x30, 0x0A};
