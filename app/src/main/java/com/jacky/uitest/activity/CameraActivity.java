...
public class CameraActivity extends BaseActivity implements OcrCallback, Handler.Callback, View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private byte[] testByteXP = new byte[]{0x47, 0x30, 0x30, 0x58, 0x2D, 0x31, 0x31, 0x30, 0x59, 0x2D, 0x30, 0x30, 0x30, 0x5A, 0x2D, 0x30, 0x30, 0x0A};
    ...
    private byte[] modeWifi_4 = new byte[]{0x47, 0x30, 0x30, 0x58, 0x2D, 0x30, 0x38, 0x30, 0x59, 0x2D, 0x36, 0x30, 0x30, 0x5A, 0x30, 0x30, 0x0A};//前往back键
